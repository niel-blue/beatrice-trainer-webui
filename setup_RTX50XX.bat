...
echo  Unofficial Simple WebUI Installer for RTX50Series
echo  =================================================
echo.
...
pip install -e .
pip install torch==2.7.0 torchvision==0.22.0 torchaudio==2.7.0 --upgrade --index-url https://download.pytorch.org/whl/cu128
